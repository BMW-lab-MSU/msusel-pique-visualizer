...
import { useFileUpload } from "../../FileUploader/use-file-uploader";
import * as schema from "../../../data/schema";
import * as definitionSchema from "../../../data/definitionSchema.ts";
import { useSetAtom, useAtomValue, useAtom } from "jotai";
import { State } from "../../../state";
import React, { useState } from "react";
 import "../../FileUploader/AlertDialog.css";
...
export const DefinitionUploader = () => {
                ...
                fileReader.onload = (e) => {
                    ...
                    try {
                        ...
                        if (validationResult.success) {
                            setDefinition(validationResult.data);
    ...
    return (
        ...
        >
            ...
            <Callout.Root size="2">
                ...
                <Callout.Text>
                    Please upload the PIQUE Definition JSON file to calibrate
                </Callout.Text>
            </Callout.Root>
