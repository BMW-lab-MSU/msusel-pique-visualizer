...
import { ClassifyNestedObjRiskLevel } from "../../Overview/ClassifyNestedObjRiskLevel";
import { COLORS } from "../../Overview/PieChartColor";
...
export  const CalibrationOverview =() =>{
    ...
    const tqiRiskData = useMemo(
        () =>
            definition ? ClassifyNestedObjRiskLevel(definition.factors.tqi, false) : null,
        [definition]
    );
    ...
    const tqiRiskLevel = useMemo(() => {
        if (!tqiRiskData || !definition) return { level: "", name: "" };
        ...
        const value = Object.values(definition.factors.tqi)[0].value;
